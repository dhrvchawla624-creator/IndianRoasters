...
function Footer({ lastUpdate }: FooterProps) {
  return (
    <footer className="bg-linear-to-br from-coffee-dark to-coffee-brown dark:from-dark-surface-elevated dark:to-dark-bg-secondary text-white px-5 py-6 md:py-8 mt-12 transition-colors duration-300">
