  ...
  return (
    <div className="bg-cream-light dark:bg-dark-bg min-h-screen flex items-center justify-center p-4 pt-24">
      <div className="w-full max-w-md text-center">
        ...
        <div className="bg-white dark:bg-dark-surface rounded-2xl shadow-xl p-8 md:p-10">
          <h1 className="text-3xl font-bold text-coffee-dark dark:text-dark-text mb-2">
          ...
          <div className="space-y-4 mb-8">
            ...
            >
              ...
              <span className="text-sm font-medium text-coffee-dark dark:text-dark-text">Sign in with Google</span>
            </button>
            <button
              type="button"
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white dark:bg-dark-surface border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-300"
            >
              ...
              <span className="text-sm font-medium text-coffee-dark dark:text-dark-text">Sign in with GitHub</span>
            </button>
          </div>
